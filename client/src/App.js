...
function App() {
  return (
    <div>
      ...
      <div className="border border-reddit border bg-reddit_dark-brighter p-5 rounded-md">
        <h5 className="text-reddit_text-darker text-sm mb-1">Posted by u/test12 5 hours ago</h5>
        <h2 className="text-xl mb-4">Vegetable Broth Recipe....</h2>
        <div className="text-sm leading-6">ook, I was gonna go easy on you
...
The very next day, "Hey Fab, I'ma kill you!"</div>
      </div>
      </div>
